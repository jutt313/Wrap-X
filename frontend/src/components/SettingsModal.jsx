            ...
            {loading ? (
              ...
              <>
                ...
                <div className="settings-documents-section">
                  <div className="settings-documents-header">
                  ...
                  {loadingDocuments ? (
                    ...
                    <div className="settings-empty-state">No documents uploaded</div>
                  ) : (
                    <div className="settings-documents-list">
                      {documents.map((doc) => (
                        <div key={doc.id} className="settings-document-item">
