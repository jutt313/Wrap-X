            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <ul>
                    <li><strong>返金:</strong> 原則として返金は行いません。お支払いいただいた料金は返金対象外となります。</li>
                  ...
                  <h3 style={{ fontSize: '1.1rem', marginTop: '1.5rem', marginBottom: '1rem' }}>返金が認められる場合</h3>
                  <p>以下の場合に限り、返金を検討いたします：</p>
                  <ul>
                    <li>当社の過失によりサービスが提供できない場合</li>
                    <li>重複課金が発生した場合</li>
                    <li>法的に返金が義務付けられている場合</li>
                  </ul>
                  <p style={{ marginTop: '1rem', fontSize: '0.9rem', color: 'rgba(255, 255, 255, 0.7)' }}>
                    ※ 返金を希望される場合は、info@wrap-x.com までご連絡ください。各ケースを個別に審査いたします。
                  </p>
                </td>
              </tr>
              <tr>
